...
const ProfileCard = ({
    ...
    // Define the condition for allowing swipes (e.g., job_title exists or city is "New York")
    ...
    // Ensure the enabled prop is explicitly a boolean
    const isGestureEnabled = !isExpanded && isTopCard && canSwipe;

    const panGesture = Gesture.Pan()
        .enabled(isGestureEnabled) // Explicit boolean value
        .activeOffsetX([-10, 10])
        .onUpdate((e) => {
            "worklet";
