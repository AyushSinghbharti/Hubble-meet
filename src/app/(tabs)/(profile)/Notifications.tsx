    ...
    >
      ...
      >
        ...
        <SettingItem
          ...
          value={toggles.newConnections}
          onValueChange={() => toggleSwitch("newConnections")}
        />
        <SettingItem
          label="Chat Notifications"
          value={toggles.chatNotifications}
          onValueChange={() => toggleSwitch("chatNotifications")}
        />
        <SettingItem
          label="All Email Notifications"
          value={toggles.allEmails}
          onValueChange={() => toggleSwitch("allEmails")}
        />
        <SettingItem
          label="Acknowledgement Emails"
          value={toggles.acknowledgmentEmails}
          onValueChange={() => toggleSwitch("acknowledgmentEmails")}
        />
        <SettingItem
          label="Reminder Emails"
          value={toggles.reminderEmails}
          onValueChange={() => toggleSwitch("reminderEmails")}
        />
        <SettingItem
          label="Feedback Emails"
          value={toggles.feedbackEmails}
          onValueChange={() => toggleSwitch("feedbackEmails")}
        />
        <SettingItem
          label="News / Marketing Emails"
